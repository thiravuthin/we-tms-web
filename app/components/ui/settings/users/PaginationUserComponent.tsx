...
const PaginationProductComponent = ({data: {total_pages, current_page, size, first, last, total_elements}, page}: { data: UserPagination, page: (pageNumber?: number, pageSize?: number) => void }) => {
