                ...
                <div className="ks_d_flex ks_pr_20">
                    ...
                    <div className="ks_pd_20">
                        ...
                        </div>
                        {
                            isUpdate && (
                                <div>
                                    <label className="ks-size-small ks-silver ks_pt_20">{ !isUpdate ? 'Updated By':''}</label>
                                </div>
                            )
                        }
                        ...
                        { isUpdate && (
                            <div className="ks_pt_5 ks_d_flex">
                                ...
                                <div className="ks_flex_row ks_ml_12 ks_jt_cont_betw">
                                    <div>
                                        <label className="fw-bold ks-size-medium">{data?.chng_by?.full_name}</label>
                                    </div>
                                    <div>
                                        <label
                                            className="ks-size-small">@{data?.chng_by?.username} . {data?.chng_by?.role} </label>
                                    </div>
                                </div>
                            </div>)}
                    </div>
                    ...
                    <div className="ks_pd_20">
                        ...
                        <div className="ks_d_flex ks_pt_20">
                            ...
                            <div className="ks_flex_row ks_ml_10 ks_jt_cont_betw">
                                ...
                                <div>
                                    <label
                                        className="fw-bold ks-size-medium">{DateUtils.formatDateHour(data?.regi_dtm)}</label>
                                </div>
                            </div>
                        </div>
                        <div className="ks_d_flex ks_pt_20">
                            ...
                            <div className="ks_flex_row ks_ml_10 ks_jt_cont_betw">
                                ...
                                <div>
                                    <label
                                        className="fw-bold ks-size-medium">{DateUtils.formatDateHour(data?.chng_dtm)}</label>
                                </div>
                            </div>
                        </div>
                    </div>
